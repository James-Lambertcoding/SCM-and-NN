...
# load model
model = load_model('Models/reg_model_long2.h5')
...
# save to CSV
test_predict.to_csv('Outputs\predictions_long2.csv',index=False)
...
# save to CSV
post_pred.to_csv('Outputs\post_predictions_long2.csv',index=False)
