...
dataset_name_lin = '09.Version2/Data/GDP_41_linear_prior.csv'
data_post_name_lin = '09.Version2/Data/GDP_41_linear_post.csv'
...
dataset_name_ND = '09.Version2/Data/GDP_41_ND_prior.csv'
data_post_name_ND = '09.Version2/Data/GDP_41_ND_post.csv'
...
prior_red_lin = dataset_lin.iloc[:,0:40]
post_red_lin = post_set_lin.iloc[:,0:40]
prior_red_nd = dataset_nd.iloc[:,0:40]
post_red_nd = post_set_nd.iloc[:,0:40]
...
train_dataset_red_lin = train_dataset_lin.iloc[:,0:40]
test_dataset_red_lin = test_dataset_lin.iloc[:,0:40]

train_dataset_red_nd = train_dataset_nd.iloc[:,0:40]
test_dataset_red_nd = test_dataset_nd.iloc[:,0:40]
...
def base_model_mse():
    model = keras.Sequential([
        layers.Dense(40, input_shape=(40,), activation='relu'),
...
## Save models
# Linear
model_1a.save("09.Version2/Models/model_1a.h5")    
model_2a.save("09.Version2/Models/model_2a.h5")    
model_3a.save("09.Version2/Models/model_3a.h5")    
model_4a.save("09.Version2/Models/model_4a.h5")    
model_5a.save("09.Version2/Models/model_5a.h5")    
model_6a.save("09.Version2/Models/model_6a.h5")    
# ND
model_1b.save("09.Version2/Models/model_1b.h5")
model_2b.save("09.Version2/Models/model_2b.h5")
model_3b.save("09.Version2/Models/model_3b.h5")
model_4b.save("09.Version2/Models/model_4b.h5")
model_5b.save("09.Version2/Models/model_5b.h5")
model_6b.save("09.Version2/Models/model_6b.h5")
...
## Save Hist to CSV
hist_1a.to_csv('09.Version2/Histories/History_1a.csv',index=False)
hist_2a.to_csv('09.Version2/Histories/History_2a.csv',index=False)
hist_3a.to_csv('09.Version2/Histories/History_3a.csv',index=False)
hist_4a.to_csv('09.Version2/Histories/History_4a.csv',index=False)
hist_5a.to_csv('09.Version2/Histories/History_5a.csv',index=False)
hist_6a.to_csv('09.Version2/Histories/History_6a.csv',index=False)
hist_1b.to_csv('09.Version2/Histories/History_1b.csv',index=False)
hist_2b.to_csv('09.Version2/Histories/History_2b.csv',index=False)
hist_3b.to_csv('09.Version2/Histories/History_3b.csv',index=False)
hist_4b.to_csv('09.Version2/Histories/History_4b.csv',index=False)
hist_5b.to_csv('09.Version2/Histories/History_5b.csv',index=False)
hist_6b.to_csv('09.Version2/Histories/History_6b.csv',index=False)
...
##Save to CSV
test_predict_1a.to_csv('09.Version2/Predictions/pred_prior_1a.csv',index=False)
test_predict_2a.to_csv('09.Version2/Predictions/pred_prior_2a.csv',index=False)
test_predict_3a.to_csv('09.Version2/Predictions/pred_prior_3a.csv',index=False)
test_predict_4a.to_csv('09.Version2/Predictions/pred_prior_4a.csv',index=False)
test_predict_5a.to_csv('09.Version2/Predictions/pred_prior_5a.csv',index=False)
test_predict_6a.to_csv('09.Version2/Predictions/pred_prior_6a.csv',index=False)
test_predict_1b.to_csv('09.Version2/Predictions/pred_prior_1b.csv',index=False)
test_predict_2b.to_csv('09.Version2/Predictions/pred_prior_2b.csv',index=False)
test_predict_3b.to_csv('09.Version2/Predictions/pred_prior_3b.csv',index=False)
test_predict_4b.to_csv('09.Version2/Predictions/pred_prior_4b.csv',index=False)
test_predict_5b.to_csv('09.Version2/Predictions/pred_prior_5b.csv',index=False)
test_predict_6b.to_csv('09.Version2/Predictions/pred_prior_6b.csv',index=False)
...
post_pred_1a.to_csv('09.Version2/Predictions/pred_post_1a.csv',index=False)
post_pred_2a.to_csv('09.Version2/Predictions/pred_post_2a.csv',index=False)
post_pred_3a.to_csv('09.Version2/Predictions/pred_post_3a.csv',index=False)
post_pred_4a.to_csv('09.Version2/Predictions/pred_post_4a.csv',index=False)
post_pred_5a.to_csv('09.Version2/Predictions/pred_post_5a.csv',index=False)
post_pred_6a.to_csv('09.Version2/Predictions/pred_post_6a.csv',index=False)
post_pred_1b.to_csv('09.Version2/Predictions/pred_post_1b.csv',index=False)
post_pred_2b.to_csv('09.Version2/Predictions/pred_post_2b.csv',index=False)
post_pred_3b.to_csv('09.Version2/Predictions/pred_post_3b.csv',index=False)
post_pred_4b.to_csv('09.Version2/Predictions/pred_post_4b.csv',index=False)
post_pred_5b.to_csv('09.Version2/Predictions/pred_post_5b.csv',index=False)
post_pred_6b.to_csv('09.Version2/Predictions/pred_post_6b.csv',index=False)
