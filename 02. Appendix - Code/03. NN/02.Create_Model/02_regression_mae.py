...
hist.to_csv('06.Outputs/Version1/History_base1_mae.csv',index=False)

test_pred_pre = model.predict(dataset_rec)

test_predict = pd.DataFrame(test_pred_pre)

test_predict.to_csv('06.Outputs/Version1/predictions1_mae.csv',index=False)

post_pred_pre = model.predict(post_set_rec)
post_pred = pd.DataFrame(post_pred_pre)

post_pred.to_csv('06.Outputs/Version1/post_predictions1_mae.csv',index=False)
    
model.save("05.Models/reg_model_mae.h5")    
