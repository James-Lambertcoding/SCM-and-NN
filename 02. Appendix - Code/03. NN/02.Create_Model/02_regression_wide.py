...
hist.to_csv('Outputs\History_base_wide.csv',index=False)
test_predict.to_csv('Outputs\predictions1_wide.csv',index=False)
post_pred.to_csv('Outputs\post_predictions_wide.csv',index=False)
model.save("models/reg_model_wide.h5")    
